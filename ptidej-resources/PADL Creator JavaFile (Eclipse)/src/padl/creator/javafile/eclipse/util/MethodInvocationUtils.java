...
public class MethodInvocationUtils {
	...
	public static IField getFieldInvocation(
		...
		// Jean Decian : added catch for NPE
		catch (final NullPointerException e) {
			System.out.println("Source of npe anEntity : " + anEntity);
			System.out.println("Source of npe field: " + field);
		}
		...
		if (field == null) {
			...
			// Jean Decian : if statement in case anEntity is null
			if (anEntity != null) {				
				anEntity.addConstituent(field);
			} else {
				System.out.println("Source of add field: " + field);
			}
		}
